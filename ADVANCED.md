...
| :--- | :--- | :--- | :--- |
| `0x0103` | Battery Level | uint8 | Battery percentage (0–100) |
| `0x010A` | Device State | uint8 | 1=off, 2=shaving, 3=charging |
| `0x010B` | Motor Current | uint16 LE | Motor current in mA |
| `0x010C` | Motor RPM | uint16 LE | Raw value (÷ 3.036 = actual RPM) |
| `0x0110` | Travel Lock | uint8 | 0=unlocked, 1=locked |
| `0x0113` | Shaving Time | uint16 LE | Total shaving time (minutes) |
| `0x0301` | Capabilities | uint8 | Capability bitfield |
