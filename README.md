...
| :--- | :---: | :---: | :--- |
| **Shaver Series 7000** | | | |
| [S7788](https://www.usa.philips.com/c-p/S7788_82/norelco-shaver-7100-wet-dry-electric-shaver-series-7000) | | :white_check_mark: | Community (#13) | 
...
For the complete setup guide and Mode A vs Mode B comparison, see **[ESP Bridge Setup Guide](esphome/SETUP.md)** and [`esphome/README.md`](esphome/README.md).
